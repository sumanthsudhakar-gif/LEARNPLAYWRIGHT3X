let float = 3.14; // Floating-point literal assigned to the variable float
console.log(float); // Output: 3.14

let float2 = 0.5; // Floating-point literal assigned to the variable float2
console.log(float2); // Output: 0.5

let float3 = 1.23e4; // Floating-point literal in scientific notation assigned to the variable float3
console.log(float3); // Output: 12300

let float4 = 5.; // Floating-point literal in scientific notation assigned to the variable float4
console.log(float4); // Output: 0.0567  

let exponential = 1.23e4; // Floating-point literal in scientific notation assigned to the variable exponential
console.log(exponential); // Output: 12300
