let Big = 1234567890123456789012345678901234567890n; // BigInt literal assigned to the variable Big
console.log(Big); // Output: 123456789012345678901234567890123
...
consoloe.log("type of NAN:", typeof NaN); // Output: number
